...
// RemoveAllTags provides a mock function with given fields:
func (_m *MockTagRepository) RemoveAllTags() error {
	ret := _m.Called()
...
func (_c *MockTagRepository_RemoveAllTags_Call) Return(_a0 error) *MockTagRepository_RemoveAllTags_Call {
	_c.Call.Return(_a0)
	return _c
}
