...
func (s *SessionTestSuite) TestCalculateEnergyConsumption() {
	var (
	...
	s.emptySession.Consumption = energyConsumption
	s.Require().InDelta(1, s.emptySession.CalculateEnergyConsumption(), 1)

	s.emptySession.Consumption = noEnergyConsumed
	s.Require().InDelta(0.0, s.emptySession.CalculateEnergyConsumption(), 1)

	s.emptySession.Consumption = multipleEnergySamples
	s.Require().InDelta(22.0, s.emptySession.CalculateEnergyConsumption(), 1)
}
