...
type LogClient interface {
	GetLogs(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (Log_GetLogsClient, error)
}
...
func (c *logClient) GetLogs(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (Log_GetLogsClient, error) {
...
type LogServer interface {
	GetLogs(*empty.Empty, Log_GetLogsServer) error
...
func (UnimplementedLogServer) GetLogs(*empty.Empty, Log_GetLogsServer) error {
