...
func (c *usersClient) AddUser(ctx context.Context, in *User, opts ...grpc.CallOption) (*AddUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/v1.api.Users/AddUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *usersClient) GetUsers(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetUsersResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/v1.api.Users/GetUsers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *usersClient) GetUser(ctx context.Context, in *GetUserRequest, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
	err := c.cc.Invoke(ctx, "/v1.api.Users/GetUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *usersClient) RemoveUser(ctx context.Context, in *RemoveUserRequest, opts ...grpc.CallOption) (*RemoveUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/v1.api.Users/RemoveUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Users_AddUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/v1.api.Users/AddUser",
	}
...
func _Users_GetUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/v1.api.Users/GetUsers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Users_GetUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/v1.api.Users/GetUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Users_RemoveUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/v1.api.Users/RemoveUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
