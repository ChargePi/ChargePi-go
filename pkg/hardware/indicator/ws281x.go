...
// ChangeColor change the color of the LED at specified index to the specified color.
...
// Blink the LED at index a certain number of times with the specified color.
// If the number of times the LED is supposed to blink is even, it will stay turned off after the blinking,
...
// Cleanup turns the LEDs off and closes the connection.
